    ...
    <>
        <section className=" flex bg-[#002228] items-center px-6 md:py-[96px]  py-[80px]">
            ...
            <div className="text-center mx-auto container">
                <h1 className='text-primary font-Mont md:text-xl text-base hover:scale-105 hover:-hue-rotate-180 transition-all duration-5000'>GET STARTED</h1>
                ...
                <Button variant="solid" color="primary" radius="full" className='text-[#002228] text-base font-medium hover:scale-105 transition-all duration-5000' style={{marginTop:"23px"}}>
