        ...
        <section className='bg-[#002228] flex justify-center'>
            ...
            <div className=' absolute inset-0 bg-no-repeat bg-contain  w-full opacity-40 bg-[url("/bg.svg")] scale-x-[-1] rounded-3xl z-0'></div>
                <div className=' z-10'>
                    ...
                    <h1 className='md:text-[40px] text-[24px] font-medium font-Mont italic text-primary tracking-[-1%] leading-[48.76px] hover:scale-105 hover:-hue-rotate-180 transition-all duration-5000'>Let us handle the rest.</h1>
                    <p className='md:text-xl text-lg tracking-[-1%] text-secondary font-light md:pt-[30px] pt-6'>Keep your reps “in the air” -- out in the field and on the phone <br /> where they can build relationships.</p>

                    <div className='md:flex md:mt-[94px] mt-[30px] place-content-center md:gap-8 space-y-8 md:space-y-0'>
                    {check.map((item, i) => (
                        <div key={i}  className="flex flex-col gap-[10px] md:w-[185px] hover:scale-105 transition-all duration-5000">
                            <span className="font-Mont md:text-[40px] text-[32px] font-bold text-base text-primary hover:-hue-rotate-180 transition-all duration-5000">{item.percent}</span>
